...
using LayoutMinishopMaster.ViewModel;
using System;
...
namespace LayoutMinishopMaster.Controllers
{
    public class MinishopMasterController : Controller
    {
        Model1 db;
        public MinishopMasterController()
        {
            db = new Model1();
        }
        // GET: MinishopMaster
        ...
        public ActionResult DeletedProduct(int id)
        {
            ...
            if (product == null)
            {
                return RedirectToAction("Index", "DeThi8");
            }
            return View(product);
        }
